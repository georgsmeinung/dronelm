...
| — | [`anexos/A9-USO-IA-GENERATIVA.md`](anexos/A9-USO-IA-GENERATIVA.md) | Metodología — documenta el uso de Claude Code (IA agéntica) en el desarrollo de la tesis: modalidades de uso, contribución cuantitativa estimada por categoría, casos de alto impacto (Bug-1, corrección policy_router, actualización masiva del informe), mejores prácticas, limitaciones y riesgos, y recomendaciones para investigadores en situación análoga | — |
