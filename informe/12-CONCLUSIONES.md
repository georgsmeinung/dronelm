...
- **Mitigación de la "maldición monocular" en pasajes densamente obstruidos (Anexo 7):**
  El fracaso uniforme de los tres brazos en el corredor arbolado `townsim_ini` (cap. 11, §11.4.2b) expuso un límite estructural del sensor monocular, no un defecto de ajuste: el flujo óptico traslacional se anula justo en los obstáculos centrados en la trayectoria de avance (cerca del Foco de Expansión), que son exactamente los de mayor riesgo de colisión frontal ([Anexo 7](anexos/A7-MALDICION-MONOCULAR-ESTEREO.md), §A7.1–§A7.2). Como línea de trabajo futuro de menor costo que un LiDAR emulado, se propone incorporar un segundo canal de profundidad instantánea mediante un **par estéreo** (baseline fija y conocida), que resuelve la ambigüedad de escala y elimina la dependencia del flujo respecto del FOE al recuperar profundidad métrica a partir de un único instante, en vez de requerir movimiento del vehículo entre frames ([Anexo 7](anexos/A7-MALDICION-MONOCULAR-ESTEREO.md), §A7.3–§A7.6). El SLAM monocular disperso o semi-denso queda como línea posterior y complementaria, útil para robustez de localización ante escena dinámica extendida, pero con limitaciones propias frente a follaje en movimiento y geometría subpíxel (Anexo 7, §A7.2.1) que no lo posicionan como sustituto directo del estéreo para este modo de falla específico.
