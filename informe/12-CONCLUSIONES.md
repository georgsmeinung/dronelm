...
- **Sensor monocular:** el canal de flujo óptico depende del movimiento del vehículo entre frames, lo que lo hace estructuralmente ciego a obstáculos centrados en la trayectoria (Foco de Expansión). El límite observado en `townsim_ini` no es resueltamente por ajuste de parámetros; requiere un segundo canal de profundidad instantánea (cap. 11, §11.5.3; Anexo 7).
